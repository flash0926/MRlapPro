...
tidy_inputGWAS <- function(GWAS, need_chrpos = TRUE, verbose=FALSE){
  ...
  GWASnames = list(SNPID = c("rsid", "snpid", "snp", "rnpid", "rs"),
                   CHR = c("chr"),
                   POS = c("pos", "position"),
                   ALT = c("a1", "alt", "alts", "effect allele", "effect_allele", "ea"),
                   REF = c("ref", "a0", "a2", "other allele", "other_allele", "nea"),
                   BETA = c("beta", "b", "beta1", "or"),
                   SE = c("se", "std"),
                   Z = c("z", "zscore"),
                   N = c("n", "neff", "samplesize"),
